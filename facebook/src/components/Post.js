        ...
        <View style={
          ...
          ></Image> */}
                    <Image style={
                        ...
                        source={
                            {
                                uri: props.item.avatar || "https://scontent.fhan15-1.fna.fbcdn.net/v/t39.30808-1/356150905_221055794134074_7342427060415828020_n.jpg?stp=cp0_dst-jpg_p60x60&_nc_cat=1&ccb=1-7&_nc_sid=5f2048&_nc_ohc=qsmztDXjbrgAX-UdlbA&_nc_ht=scontent.fhan15-1.fna&oh=00_AfDT1VZf8gV7mZsMT07r4iENKWnEi-KoIXCYDju-9BcRlw&oe=653C4A7B"
                            }
                        }/>
            ...
            <View style={
                ...
                <View style={
                    ...
                    <Image style={
                        ...
                        contentFit="cover"
                        source={
                            require("../assets/icons/likeIconColor.png")
                        }/>
                    <Text style={
                        {
                            fontSize: 16,
            ...
            <View style={
                ...
                <TouchableOpacity 
                    ...
                    <View style={
                        ...
                        <Image style={
                            ...
                            contentFit="cover"
                            source={
                                require("../assets/icons/commentIcon.png")
                            }/>
                        <Text style={
                            {
                                marginLeft: 4,
                ...
                <View style={
                    ...
                    <Image style={
                        ...
                        contentFit="cover"
                        source={
                            require("../assets/icons/shareIcon.png")
                        }/>
                    <Text style={
                        {
                            marginLeft: 4,
