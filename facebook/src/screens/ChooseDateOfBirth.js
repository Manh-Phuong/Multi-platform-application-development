            ...
            >
                ...
                <View style={styles.headerText}>
                    ...
                    <Text style={styles.subText}>
                        Chọn ngày sinh của bạn. Bạn luôn có thể đặt thông tin này ở chế độ riêng tư vào lúc khác. Tại
                        sao tôi cần cung cấp ngày sinh của mình?
                    </Text>
                </View>
                <View>
                    <Text style={styles.textLabel}>Ngày sinh</Text>
                    <View style={[styles.textInputContainer, isFocusDate ? styles.focusedInput : null]}>
                        <Text
