...
const CreateName = () => {
    ...
    const inputBorderStyleName = isFocusedName ? { borderColor: 'black', borderWidth: 1 } : {};
    const inputBorderStyleSurName = isFocusedSurName ? { borderColor: 'black', borderWidth: 1 } : {};
    ...
    const handleSummit = () => {
        if (!name.trim()) {
            Alert.alert('Tên không được để trống', 'Hãy nhập tên của bạn để tiếp tục.', [
                {
                    text: 'OK',
                    onPress: () => {
            ...
            Alert.alert('Họ không được để trống', 'Hãy nhập họ của bạn để tiếp tục.', [
                {
                    text: 'OK',
                    onPress: () => {
    ...
    return (
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
            ...
            >
                ...
                <Text style={[styles.nhpTnBn, styles.bnTnGClr]}>Nhập tên bạn sử dụng trong đời thực.</Text>
