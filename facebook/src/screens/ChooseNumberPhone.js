        ...
        <TouchableWithoutFeedback onPress={
            ...
            <LinearGradient colors={
                ...
                <TouchableOpacity onPress={goBackHandler}>
                    <Image style={
                            [styles.vectorIcon, styles.iconLayout]
                        }
                        contentFit="cover"
                        source={
                ...
                <Text style={
                    [styles.bnTnG]
                }>Địa chỉ email của bạn là gì?</Text>
                <Text style={
                    [styles.nhpTnBn1]
                }>
                ...
                <View>
                    <KeyboardAvoidingView>
                        <TextInput style={
                                [styles.inputtextPosition1, inputBorderStyleEmail]
                            }
